...
const Projects = () => {
    ...
    return (
        <section id="projects" className="section-spacing relative overflow-x-hidden">
            ...
            <div className="container-custom relative z-10">
                <div className="text-center mb-16 slide-up">
                    <h2 className="mb-4 text-4xl md:text-5xl font-bold" style={{ color: 'var(--space-cyan)' }}>My Projects</h2>
                    <p className="text-xl text-white/70 max-w-2xl mx-auto">
                        Projects and works I've developed
                    </p>
                </div>
                            ...
                            <div className="flex gap-4 pt-4 border-t border-white/5 mt-auto">
                                ...
                                {project.github && (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex-1 glass-space text-white-50 px-4 py-3 rounded-xl font-semibold hover:bg-white/10 transition-all text-center text-sm flex items-center justify-center gap-2 group"
                                    >
                                        <span>View Code</span>
                ...
                {projects.length === 0 && (
                    <div className="text-center py-16">
                        <p className="text-white/60 text-lg">No projects added yet</p>
                    </div>
                )}
            </div>
        </section>
